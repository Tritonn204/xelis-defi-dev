...
import { create_typed_contract } from "./TypedContract";
...
describe('Contract Class Tests', () => {
  ...
  describe('Dynamic Method Invocation', () => {
    test('should call addLiquidity with deposits', () => {
      ...
      expect(result.invoke_contract.maxGas).toBe(300000000);
  ...
  describe('Typed Contract Creation', () => {
    test('should create typed router contract', () => {
      const router = create_typed_contract(ROUTER_ADDRESS, routerABI);
    ...
    test('should create typed factory contract', () => {
      const factory = create_typed_contract(FACTORY_ADDRESS, factoryABI);
  ...
  describe('Default Values', () => {
    test('should use default maxGas if not provided', () => {
      ...
      expect(result.invoke_contract.maxGas).toBe(50000000); // default
    });
    ...
    test('should override default maxGas when provided', () => {
      ...
      expect(result.invoke_contract.maxGas).toBe(100000000);
    });
  });
});
...
describe('Integration Example', () => {
  test('complete DEX interaction flow', () => {
    ...
    const router = create_typed_contract(routerAddress, routerABI);
